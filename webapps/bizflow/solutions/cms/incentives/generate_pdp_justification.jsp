...
<%!
    static final String DEFAULT_DOCUMENT_TYPE = "PDP Justification-Computation";
    static final String DEFAULT_FILE_NAME = "PDP-Justification-Computation.pdf";
...
<%
    ...
    try {
        ...
        documentType = properties.getProperty("report.PDPJustificationComputation.documentType", DEFAULT_DOCUMENT_TYPE);
        fileName = properties.getProperty("report.PDPJustificationComputation.fileName", DEFAULT_FILE_NAME);
        reportPath = properties.getProperty("report.PDPJustificationComputation.path");
    ...
    if (null == errorMsg) {
        try {
            ...
            if (worksheetFile != null && 0 < worksheetFile.length()) {
                ...
                errorMsg = "[Internal Error] Cannot create a PDP Justification-Computation pdf.";
            }
