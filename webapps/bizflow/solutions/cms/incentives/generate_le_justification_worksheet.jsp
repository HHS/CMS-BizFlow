...
<%!
    static final String DEFAULT_DOCUMENT_TYPE = "LE Justification Worksheet";
    static final String DEFAULT_FILE_NAME = "LE Justification Worksheet.pdf";
    ...
    if (null == errorMsg) {
        try {
            ...
            if (worksheetFile != null && 0 < worksheetFile.length()) {
                ...
                errorMsg = "[Internal Error] Cannot create an LE Justification Worksheet.";
            }
