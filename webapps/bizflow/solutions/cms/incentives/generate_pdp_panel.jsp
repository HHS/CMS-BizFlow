...
<%!
    static final String DEFAULT_DOCUMENT_TYPE = "PDP Panel Documentation";
    static final String DEFAULT_FILE_NAME = "PDP_Panel_Documentation.pdf";
...
<%
    ...
    try {
        ...
        documentType = properties.getProperty("report.PDPPanel.documentType", DEFAULT_DOCUMENT_TYPE);
        fileName = properties.getProperty("report.PDPPanel.fileName", DEFAULT_FILE_NAME);
        reportPath = properties.getProperty("report.PDPPanel.path");
    ...
    if (null == errorMsg) {
        try {
            ...
            if (worksheetFile != null && 0 < worksheetFile.length()) {
                ...
                errorMsg = "[Internal Error] Cannot create a PDP Panel Documentation pdf.";
            }
