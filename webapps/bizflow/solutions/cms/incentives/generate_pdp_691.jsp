...
<%!
    static final String DEFAULT_DOCUMENT_TYPE = "HHS 691";
    static final String DEFAULT_FILE_NAME = "HHS-691.pdf";
...
<%
    ...
    try {
        ...
        documentType = properties.getProperty("report.PDP691.documentType", DEFAULT_DOCUMENT_TYPE);
        fileName = properties.getProperty("report.PDP691.fileName", DEFAULT_FILE_NAME);
        reportPath = properties.getProperty("report.PDP691.path");
    ...
    if (null == errorMsg) {
        try {
            ...
            if (worksheetFile != null && 0 < worksheetFile.length()) {
                ...
                errorMsg = "[Internal Error] Cannot create a PDP 691 pdf.";
            }
