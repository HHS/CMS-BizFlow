...
-- Change default profile to lift password expiration
...
CREATE USER HHSADMIN IDENTIFIED BY hhsAdminPass;
GRANT CONNECT, RESOURCE, DBA TO HHSADMIN;

-- ALTER USER HHSADMIN IDENTIFIED BY hhsAdminPass;
...
CREATE USER HHS_HR IDENTIFIED BY hhspass
	DEFAULT TABLESPACE HHS_HR_TS
--	TEMPORARY TABLESPACE HHSTST
	QUOTA UNLIMITED ON HHS_HR_TS
;
-- ALTER USER HHS_HR IDENTIFIED BY hhspass;

-- developer user
CREATE USER HHSDEV IDENTIFIED BY hhsDevPass
	DEFAULT TABLESPACE HHS_HR_TS
	QUOTA UNLIMITED ON HHS_HR_TS
;
-- ALTER USER HHSDEV IDENTIFIED BY hhsDevPass;
...
-- Already granted as part of CMS project
--BEGIN
