...
public class CMSUtility
{
	...
	static public String getOrganizationName(Node document) {
		StopWatch watch = new StopWatch(CMSUtility.class, "getThirdOrganizationName");
		if (logger.isDebugEnabled())
		{
			logger.debug("getOrganizationName START");
			logger.debug(" - document [" + LogUtility.getNullCheckString(document) + "]");
		}
