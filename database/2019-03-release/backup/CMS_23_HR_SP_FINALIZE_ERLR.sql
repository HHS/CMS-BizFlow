...
BEGIN
    ...
    DELETE ERLR_EMPLOYEE_CASE WHERE CASE_NUMBER = V_CASE_NUMBER;
    IF V_GEN_EMP_ID IS NOT NULL THEN
        INSERT INTO ERLR_EMPLOYEE_CASE (HHSID, CASE_NUMBER) VALUES (V_GEN_EMP_ID, V_CASE_NUMBER);
    END IF;
