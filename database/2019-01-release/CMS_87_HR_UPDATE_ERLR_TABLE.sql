				...
				FROM TBL_FORM_DTL FD
					, XMLTABLE('/formData/items' PASSING FD.FIELD_DATA
						COLUMNS
	                        ...
	                        , GEN_CMS_PRIMARY_REP_ID VARCHAR2(10)  PATH './item[id="GEN_CMS_PRIMARY_REP"]/value/name'
                ...
                FROM TBL_FORM_DTL FD
                    , XMLTABLE('/formData/items'
						...
						COLUMNS
							...
							, CI_APPROVAL_NAME	NVARCHAR2(10)	PATH './item[id="CI_APPROVAL_NAME"]/value/name'
							...
							, CI_APPROVAL_NAME_2	NVARCHAR2(10)	PATH './item[id="CI_APPROVAL_NAME_2"]/value/name'
							...
							, CI_DECIDING_OFFCL	NVARCHAR2(10)	PATH './item[id="CI_DECIDING_OFFCL"]/value/name'
							...
							, CI_DECIDING_OFFCL_NAME	NVARCHAR2(10)	PATH './item[id="CI_DECIDING_OFFCL_NAME"]/value/name'
							...
							, CI_SUSP_DECIDING_OFFCL_NAME	NVARCHAR2(10)	PATH './item[id="CI_SUSP_DECIDING_OFFCL_NAME"]/value/name'
                ...
                FROM TBL_FORM_DTL FD
                    , XMLTABLE('/formData/items'
						...
						COLUMNS
							...
							, PI_DMTN_FIN_DECIDING_OFC NVARCHAR2(10)	PATH './item[id="PI_DMTN_FIN_DECIDING_OFC_NM"]/value/name'
							...
							, PI_PIP_DECIDING_OFFICAL	NVARCHAR2(10)	PATH './item[id="PI_PIP_DECIDING_OFFICAL_NM"]/value/name'
							...
							, PI_RMV_FIN_DECIDING_OFC	NVARCHAR2(10)	PATH './item[id="PI_RMV_FIN_DECIDING_OFC_NM"]/value/name'
                ...
                FROM TBL_FORM_DTL FD
                    , XMLTABLE('/formData/items'
						...
						COLUMNS
							...
							, GI_IND_MANAGER	NVARCHAR2(10) PATH './item[id="GI_IND_MANAGER"]/value/name'
							...
							, GI_ADMIN_OFFCL_1	NVARCHAR2(10) PATH './item[id="GI_ADMIN_OFFCL_1"]/value/name'
							...
							, GI_ADMIN_OFFCL_2	NVARCHAR2(10) PATH './item[id="GI_ADMIN_OFFCL_2"]/value/name'
                ...
                FROM TBL_FORM_DTL FD
                    , XMLTABLE('/formData/items'
						...
						COLUMNS                            
							...
							, PPA_TERM_DECIDING_OFFCL_NAME	NVARCHAR2(10)	PATH './item[id="PPA_TERM_DECIDING_OFFCL_NAME"]/value/name'
							...
							, PPA_DECIDING_OFFCL	NVARCHAR2(10)	PATH './item[id="PPA_DECIDING_OFFCL"]/value/name'
