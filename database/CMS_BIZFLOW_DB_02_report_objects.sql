...
GRANT EXECUTE ON BIZFLOW.HHS_FN_GET_BUSDAYSDIFF TO HHS_CMS_HR_RW_ROLE;
GRANT EXECUTE ON BIZFLOW.HHS_FN_GET_BUSDAYSDIFF TO HHS_CMS_HR_DEV_ROLE;
GRANT EXECUTE ON BIZFLOW.HHS_FN_GET_BUSDAYSDIFF TO HHS_CMS_HR;
...
GRANT SELECT ON BIZFLOW.HHS_VW_CONSULTATION_PROC TO HHS_CMS_HR_RW_ROLE;
GRANT SELECT ON BIZFLOW.HHS_VW_CONSULTATION_PROC TO HHS_CMS_HR_DEV_ROLE;
GRANT SELECT ON BIZFLOW.HHS_VW_CONSULTATION_PROC TO HHS_CMS_HR;

------------------------------
-- HHS_VW_CLASSIFICATION_PROC
------------------------------
