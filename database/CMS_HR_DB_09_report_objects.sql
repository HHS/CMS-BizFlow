...
AS
	...
	SELECT * FROM (
								SELECT RR.REQ_ID, RR.REQ_JOB_REQ_NUMBER REQUEST_NUMBER, RR.REQ_JOB_REQ_CREATE_DT REQUEST_DATE
										...
										, VST.POS_NTE, VST.POS_WORK_SCHED_ID, VST.POS_WORK_SCHED_DSCR, VST.POS_HOURS_PER_WEEK
								...
								SELECT RR.REQ_ID, RR.REQ_JOB_REQ_NUMBER REQUEST_NUMBER, RR.REQ_JOB_REQ_CREATE_DT REQUEST_DATE
										...
										, VEL.NTE POS_NTE, VEL.WORK_SCHED_ID POS_WORK_SCHED_ID, VEL.WORK_SCHED_DSCR POS_WORK_SCHED_DSCR, VEL.HOURS_PER_WEEK POS_HOURS_PER_WEEK
								FROM VW_UNIFIED_REQUESTS_RANK RR
