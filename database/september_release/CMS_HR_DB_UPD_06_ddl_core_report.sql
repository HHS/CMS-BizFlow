...
BEGIN
	...
	--TODO: Form validation doesn't enforce numeric data.  Either validate it by form or check it here.
...
SELECT
	...
	, CASE WHEN POS.POS_BGT_APR_OFM = '1' THEN 'Yes' ELSE 'No' END AS POS_BGT_APR_OFM
	, POS.POS_TITLE
	, POS.POS_PAY_PLAN_ID
	...
	, CASE WHEN POS.POS_GA_1  = '1'      THEN '1; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_2  = '1' THEN '2; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_3  = '1' THEN '3; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_4  = '1' THEN '4; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_5  = '1' THEN '5; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_6  = '1' THEN '6; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_7  = '1' THEN '7; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_8  = '1' THEN '8; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_9  = '1' THEN '9; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_10 = '1' THEN '10; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_11 = '1' THEN '11; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_12 = '1' THEN '12; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_13 = '1' THEN '13; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_14 = '1' THEN '14; ' ELSE '' END
		|| CASE WHEN POS.POS_GA_15 = '1' THEN '15; ' ELSE '' END
	AS POS_GA
	...
	, CASE WHEN AOC.AOC_30PCT_DISABLED_VETS = '1'      THEN '30% or More Disabled Veterans; ' ELSE '' END
		|| CASE WHEN AOC.AOC_EXPERT_CONS = '1'         THEN 'Expert/Consultant; ' ELSE '' END
		|| CASE WHEN AOC.AOC_IPA = '1'                 THEN 'Intergovernmental Personnel Act (IPA); ' ELSE '' END
		|| CASE WHEN AOC.AOC_OPER_WARFIGHTER = '1'     THEN 'Operation Warfighter Program; ' ELSE '' END
		|| CASE WHEN AOC.AOC_DISABILITIES = '1'        THEN 'Schedule A (for persons with disabilities); ' ELSE '' END
		|| CASE WHEN AOC.AOC_STUDENT_VOL = '1'         THEN 'Student Volunteer Program; ' ELSE '' END
		|| CASE WHEN AOC.AOC_VETS_RECRUIT_APPT = '1'   THEN 'Veterans Recruitment Appointment; ' ELSE '' END
		|| CASE WHEN AOC.AOC_VOC_REHAB_EMPL = '1'      THEN 'Voc. Rehab & Employment Program; ' ELSE '' END
		|| CASE WHEN AOC.AOC_WORKFORCE_RECRUIT = '1'   THEN 'Workforce Recruitment Program; ' ELSE '' END
	AS AOC_ANNOUNCE_NOT_REQ
	, CASE WHEN AOC.AOC_MIL_SPOUSES = '1'              THEN 'Certain Military Spouses; ' ELSE '' END
		|| CASE WHEN AOC.AOC_DIRECT_HIRE = '1'         THEN 'Direct Hire; ' ELSE '' END
		|| CASE WHEN AOC.AOC_RE_EMPLOYMENT = '1'       THEN 'Reemployed Annuitant; ' ELSE '' END
		|| CASE WHEN AOC.AOC_PATHWAYS = '1'            THEN 'Pathways Program (Intern, PMF, RG); ' ELSE '' END
		|| CASE WHEN AOC.AOC_PEACE_CORPS_VOL = '1'     THEN 'Peace Corps/Volunteers; ' ELSE '' END
		|| CASE WHEN AOC.AOC_REINSTATEMENT = '1'       THEN 'Reinstatement; ' ELSE '' END
		|| CASE WHEN AOC.AOC_SHARED_CERT = '1'         THEN 'Shared Certificate; ' ELSE '' END
	AS AOC_ANNOUNCE_REQ
	, CASE WHEN AOC.AOC_DELEGATE_EXAM = '1'            THEN 'Delegated Examining (DE) - All U.S. citizens; ' ELSE '' END
		|| CASE WHEN AOC.AOC_DH_US_CITIZENS = '1'      THEN 'Direct Hire - All U.S. citizens; ' ELSE '' END
		|| CASE WHEN AOC.AOC_MP_GOV_WIDE = '1'         THEN 'MP Government-wide; ' ELSE '' END
		|| CASE WHEN AOC.AOC_MP_HHS_ONLY = '1'         THEN 'MP HHS-wide ONLY; ' ELSE '' END
		|| CASE WHEN AOC.AOC_MP_CMS_ONLY = '1'         THEN 'MP CMS-wide ONLY; ' ELSE '' END
		|| CASE WHEN AOC.AOC_MP_COMP_CONS_ONLY = '1'   THEN 'MP Component/Consortium-wide ONLY; ' ELSE '' END
		|| CASE WHEN AOC.AOC_MP_I_CTAP_VEGA = '1'      THEN 'ICTAP and VEOA Only; ' ELSE '' END
	...
	, CASE WHEN JA.JA_TYPE_YES_NO = '1'           THEN 'Yes/No (True/False); ' ELSE '' END
		|| CASE WHEN JA.JA_TYPE_REQ_DEFAULT = '1' THEN 'Default scale; ' ELSE '' END
		|| CASE WHEN JA.JA_TYPE_KNOWL_SCALE = '1' THEN 'Knowledge scale; ' ELSE '' END
	AS JA_ASSESS_TYPE
